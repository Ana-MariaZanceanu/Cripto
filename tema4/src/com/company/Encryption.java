...
public class Encryption {
    ...
    private int[][] P;
    public Encryption(){}
    public Encryption(int[] message,int[][] subkeys,int[][] IP,int[][] invIP,int[][] E,int[][] S1,int[][] S2,int[][] S3,int[][] S4,int[][] S5,int[][] S6,int[][] S7,int[][] S8,int[][] P){
...
//        print(R0);
        ...
        int[] encrypted = permute(64,invIP,Rev);
        return encrypted;
    }
}
